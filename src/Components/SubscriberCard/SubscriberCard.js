...
const useStyles = makeStyles(({ breakpoints, spacing, shadows }) => ({
  ...
  messageBox :{
    ...
    color: '#06044d',
    background: '#FFFFFF',
    background: '-webkit-radial-gradient(center, #FFFFFF, #F0EBE4)',
    background: '-moz-radial-gradient(center, #FFFFFF, #F0EBE4)',
    background: 'radial-gradient(ellipse at center, #FFFFFF, #F0EBE4)',
...
const makeColumn = (str, comp) => {
  return <Grid container justify="space-between"  alignItems="baseline">
            <Grid item>
