...
export default function BulkDistributionListForm(props) {
  ...
  const onSubmit = data => {
    ...
    data.bdldDistIds =
        data.bdldDistIds.includes('All Distributors') 
          ...
          >
            ...
            <Grid item>
              <TextField
                required
                onChange={(e) => {
                    setValue("bdldCurrentVol",e.target.value);
                  }}
                type="number"
                id="bdldCurrentVol"
                name="bdldCurrentVol"
                label="For Issue Number"
                autoComplete="bdldCurrentVol"
                fullWidth
              />
            </Grid>
